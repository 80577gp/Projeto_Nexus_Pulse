...
class Mission(models.Model):
    """Represents a mission assigned to a student."""
    ...
    external_reference = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Optional external reference for the mission origin.",
    )
...
class GradeCorrelation(models.Model):
    """Relates mission effort to the student's grade outcome."""
    ...
    external_reference = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Optional external reference used in the grade correlation analysis.",
    )
    ...
    def __str__(self):
        ...
        reference = self.external_reference or "manual-entry"
        return f"{self.student.email} - {reference}"
